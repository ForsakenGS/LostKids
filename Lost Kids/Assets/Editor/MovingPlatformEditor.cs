...
public class MovingPlatformEditor : Editor
{
    ...
    {
        //type1Var is only visible when type == Type1
        
        ShowOnEnum("speedMode", "Constant", "moveSpeed");
        ShowOnEnum("speedMode", "Custom", "pointSpeed");

        //ShowOnEnum("delayMode", "Extremes", "extremesDelay");
        ShowOnEnum("delayMode", "Custom", "pointDelay");
